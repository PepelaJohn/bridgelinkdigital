...
export function StatCard({ icon, title, value, counterSuffix }: StatCardProps) {
  return (
    <div className="group rounded-5 bg-accent-100 p-30px dark:bg-accent-700 relative min-h-[155px] overflow-hidden">
      ...
      <h3 className="font-secondary pr-20 text-xl leading-tight font-bold text-transparent [-webkit-text-fill-color:transparent] [-webkit-text-stroke:1px_#1A1A1C] md:text-2xl dark:[-webkit-text-stroke:1px_white]">
