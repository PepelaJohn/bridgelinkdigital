...
const menuTriggerClasses = cn([
  ...
  // General
  'text-base leading-[1.3] capitalize py-4 min-h-14 font-medium dark:text-white text-accent-900  dark:hover:text-primary hover:text-primary transition-colors duration-200',
