        ...
        <div className="p-8">
          <div className="mb-10">
            ...
            <p className="mb-4 text-gray-200">
              ...
              marketing, website design, website development, and SEO services,
          ...
          <div className="mb-10">
            ...
            <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-200">
              ...
              <li>
                ...
                zone setting, browser plug-in types, operating system and
                platform.
              </li>
              <li>
            ...
            <p className="mb-4 text-gray-200">
              ...
              you (this includes details about your race, ethnicity, religious
              beliefs, sexual orientation, political opinions, and health data).
            </p>
          </div>
          ...
          <div className="mb-10">
            ...
            <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-200">
              <li>
                <span className="font-medium">Direct interactions</span>: You
                may provide us with your personal data when filling in forms,
                corresponding with us, requesting our services, or providing
                feedback.
              </li>
              <li>
                <span className="font-medium">Automated technologies</span>: As
                you interact with our website, we may automatically collect
                Technical Data about your browsing actions and patterns. We
                collect this data using cookies and similar technologies.
              </li>
              <li>
                <span className="font-medium">Third parties</span>: We may
                receive personal data about you from various third parties such
                as analytics providers and advertising networks.
              </li>
            </ul>
          </div>
